...
<body>
	<div align="center">
		...
		<h2>비회원로그인</h2>
		<form action="${pageContext.servletContext.contextPath}/ticket/auth.do"method="post">
			<p>
				<input type="text" placeholder="예약자이름" name="nick"/>
			</p>
			<p>
				<input type="tel" placeholder="예약자연락처" name="phon"/>
			</p>
			<p>
